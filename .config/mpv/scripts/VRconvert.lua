...
local initFunction = function()
	...
	mp.add_forced_key_binding("i", function() increment_roll(-1) end, 'repeatable')
	...
	mp.add_forced_key_binding("j", function() increment_pitch(-1) end, 'repeatable')
	mp.add_key_binding("l", function() increment_yaw(1)  end, 'repeatable')
	mp.add_key_binding("h", function() increment_yaw(-1) end, 'repeatable')
	mp.add_key_binding("c", "easy_crop", updateFilters)

	mp.add_forced_key_binding("y", function() increment_res(1)  end, 'repeatable')
	mp.add_forced_key_binding("u", function() increment_res(-1) end, 'repeatable')
