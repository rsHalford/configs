...
local windows_paste = 'powershell' --'powershell' is for using windows powershell to paste. OR wte the paste command
...
if device == 'mac' then --MAC OS Keybinds
	...
	mp.add_key_binding('ctrl+alt+c', 'copy', copy)
	mp.add_key_binding('ctrl+alt+C', 'copyCaps', copy)
	mp.add_key_binding('ctrl+alt+v', 'paste', paste)
	mp.add_key_binding('ctrl+alt+V', 'pasteCaps', paste)

	mp.add_key_binding('ctrl+c', 'copy-path', copy_path)
	mp.add_key_binding('ctrl+C', 'copy-pathCaps', copy_path)
